...
//   console.log(todos);
  ...
  if (isErrorTodo)
    return (
      <div className="text-center text-2xl font-bold">Error fetching todos</div>
    );
  return (
        ...
        <nav className="flex justify-center items-center flex-wrap gap-2">
          ...
          <Button
            ...
            className={`bg-gray-200 px-[10px] py-1 rounded-md text-gray-500 cursor-pointer ${
              pageParam === 1
                ? ""
                : "hover:bg-secBackground/90 hover:text-white transition-all duration-300"
            }`}
